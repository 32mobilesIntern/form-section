    ...
    return (
        <div>
            <div className="flex items-center gap-2">
                <h2 className="text-[#1570EF] font-bold text-xl leading-9">Mandatory</h2>
                <div className="w-full border border-[#84caff] h-[0.5px]"></div>
            </div>
            <div>
                <form onSubmit={handleSubmit(onSubmit)} className="p-5 bg-[#EFF8FF]">
